...
const AboutSection = () => {
  ...
  return (
    <section id="about" className="py-20 bg-gradient-to-b from-gray-50 to-white dark:from-gray-800 dark:to-gray-900 relative overflow-hidden">
      {/* Background Elements */}
      <div className="absolute inset-0">
        <div className="absolute top-20 right-20 w-40 h-40 bg-blue-200 dark:bg-blue-800 rounded-full opacity-10 animate-pulse"></div>
        <div className="absolute bottom-32 left-16 w-32 h-32 bg-purple-200 dark:bg-purple-800 rotate-45 opacity-10 animate-spin" style={{ animationDuration: '20s' }}></div>
        <div className="absolute top-1/2 right-1/4 w-20 h-20 bg-pink-200 dark:bg-pink-800 rounded-full opacity-10 animate-bounce"></div>
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-900 dark:text-white mb-4">
            About <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">AryaPathshala</span>
          </h2>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-2xl p-8 sm:p-12 border border-gray-200 dark:border-gray-700">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <ul className="space-y-4">
                  {currentTab.content.points.map((point, index) => (
                    ...
                    >
                      <span className="flex-shrink-0 w-6 h-6 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full flex items-center justify-center text-white text-sm font-bold mt-0.5">
                        ✓
                      </span>
              ...
              <div className="relative">
                <div className="bg-gradient-to-br from-blue-100 to-purple-100 dark:from-blue-900/20 dark:to-purple-900/20 rounded-2xl p-8 relative overflow-hidden">
                  {/* Decorative elements based on active tab */}
                  {activeTab === 'mission' && (
                    <div className="space-y-6">
                      <div className="text-center">
                        <div className="text-6xl mb-4">🎯</div>
                        <h4 className="text-xl font-bold text-gray-900 dark:text-white">Our Mission</h4>
                      </div>
                      <div className="grid grid-cols-2 gap-4">
                        <div className="text-center p-4 bg-white dark:bg-gray-800 rounded-lg shadow-md">
                          <span className="text-2xl">📚</span>
                          <p className="text-sm font-medium text-gray-700 dark:text-gray-300 mt-2">Quality Content</p>
                        </div>
                        <div className="text-center p-4 bg-white dark:bg-gray-800 rounded-lg shadow-md">
                          <span className="text-2xl">👨‍🎓</span>
                          <p className="text-sm font-medium text-gray-700 dark:text-gray-300 mt-2">Student Success</p>
                        </div>
                      </div>
                    </div>
                  )}
                  ...
                  {activeTab === 'vision' && (
                    <div className="space-y-6">
                      ...
                      <div className="space-y-3">
                        <div className="flex items-center space-x-3 p-3 bg-white dark:bg-gray-800 rounded-lg shadow-md">
                          <span className="text-xl">🌍</span>
                          <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Global Impact</span>
                        </div>
                        <div className="flex items-center space-x-3 p-3 bg-white dark:bg-gray-800 rounded-lg shadow-md">
                          <span className="text-xl">🚀</span>
                  ...
                  {activeTab === 'approach' && (
                    <div className="space-y-6">
                      <div className="text-center">
                        <div className="text-6xl mb-4">🚀</div>
                        <h4 className="text-xl font-bold text-gray-900 dark:text-white">Our Approach</h4>
                      </div>
                      <div className="space-y-3">
                        ...
                        <div className="flex items-center justify-between p-3 bg-white dark:bg-gray-800 rounded-lg shadow-md">
                          <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Practice & Assessment</span>
                          <span className="text-xl">📝</span>
                        </div>
                      </div>
                    </div>
        ...
        <div id="about-stats" className="mb-20">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="text-center p-6 bg-white dark:bg-gray-800 rounded-2xl shadow-lg hover:shadow-xl transform hover:-translate-y-2 transition-all duration-300">
              <div className="text-4xl mb-4">👨‍🎓</div>
              <div className="text-3xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent mb-2">
                {counters.students.toLocaleString()}+
              </div>
              <div className="text-sm font-medium text-gray-600 dark:text-gray-400">Happy Students</div>
            </div>
            ...
            <div className="text-center p-6 bg-white dark:bg-gray-800 rounded-2xl shadow-lg hover:shadow-xl transform hover:-translate-y-2 transition-all duration-300">
              ...
              <div className="text-sm font-medium text-gray-600 dark:text-gray-400">Video Lectures</div>
            </div>
            ...
            <div className="text-center p-6 bg-white dark:bg-gray-800 rounded-2xl shadow-lg hover:shadow-xl transform hover:-translate-y-2 transition-all duration-300">
              ...
              <div className="text-sm font-medium text-gray-600 dark:text-gray-400">Practice Papers</div>
            </div>
        ...
        <div className="mb-20">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value, index) => (
              <div
                key={index}
                className="text-center p-6 bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-700 rounded-2xl shadow-lg hover:shadow-xl transform hover:-translate-y-3 transition-all duration-300 border border-gray-200 dark:border-gray-600 group"
        ...
        <div className="mb-20">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {achievements.map((achievement, index) => (
              <div
                key={index}
                className="relative text-center p-8 bg-white dark:bg-gray-800 rounded-2xl shadow-lg hover:shadow-xl transform hover:-translate-y-2 transition-all duration-300 border border-gray-200 dark:border-gray-700 group overflow-hidden"
              >
                ...
                {/* Decorative elements */}
                <div className="absolute top-2 right-2 text-xl opacity-20 group-hover:opacity-40 transition-opacity duration-300">
                  {index % 2 === 0 ? '⭐' : '🎯'}
                </div>
              </div>
            ))}
        ...
        <div className="mb-20">
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-3xl p-8 sm:p-12 text-white relative overflow-hidden">
            {/* Background pattern */}
            <div className="absolute inset-0 opacity-10">
              <div className="absolute top-10 left-10 w-20 h-20 border-2 border-white rounded-full"></div>
              <div className="absolute bottom-10 right-10 w-16 h-16 border-2 border-white rotate-45"></div>
            ...
            <div className="relative z-10 text-center">
              ...
              <div className="mt-8">
                <button
                  ...
                  className="px-8 py-4 bg-white text-blue-600 rounded-xl font-semibold text-lg hover:bg-gray-100 transform hover:-translate-y-1 transition-all duration-300 shadow-lg hover:shadow-xl"
                >
        ...
        <div className="text-center">
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg border border-gray-200 dark:border-gray-700">
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-8">
              ...
              <div className="text-center p-4">
                <div className="text-3xl mb-3">💬</div>
                <h4 className="font-semibold text-gray-900 dark:text-white mb-2">Chat Support</h4>
                <p className="text-gray-600 dark:text-gray-400 text-sm">
                  24/7 Online Support
                </p>
              </div>
