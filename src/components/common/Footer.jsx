        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center space-x-3 mb-4">
              <div className="w-12 h-12 rounded-full overflow-hidden border-2 border-yellow-500/30 bg-zinc-900">
                <img
                  src="/logo_arya.jpg"
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              {/* <li>
                <a href="/class9" className="text-gray-300 hover:text-yellow-400 transition-colors duration-200 text-sm">
                  Class 9 Materials
                </a>
              </li>
              <li>
                <a href="/class10" className="text-gray-300 hover:text-yellow-400 transition-colors duration-200 text-sm">
                  Class 10 Materials
                </a>
              </li> */}
              <li>
                <a href="/gaurav" className="text-gray-400 hover:text-yellow-400 transition-colors duration-200 text-xs opacity-50">
                  Admin Portal
                </a>
              </li>
            </ul>
